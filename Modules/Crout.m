format long
A=[1 0 0 0;-2 2 0 0;3 0 2 0;-5 2 1 1];
b=[-7 16 -17 39];

format long
A=input('Digitar Matriz:');
b=input('Digitar El Vector de los independientes :');
b=b';
...
if n==m
 ...
 L(i,k)=(A(i,k)-suma); %obtención de la matriz L
 end
 for j=k+1:n
 suma=0;
 for s=1:k-1
 ...
 u(k,j)=(A(k,j)-suma)/L(k,k); %obtención de la matriz U
 end
 end
